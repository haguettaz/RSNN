...
for period in tqdm(range(100, 1100, 100)): # max period to determine later
    ...
    for l in trange(100):
        for num_unique_inputs in [NUM_INPUTS, NUM_INPUTS // 10, NUM_INPUTS // 100]:
            if os.path.exists(os.path.join("neurons", f"neuron_{l}_{period}_{num_unique_inputs}.pkl")):
                continue
            ...
            save_object_to_file(neuron, os.path.join("neurons", f"neuron_{l}_{period}_{num_unique_inputs}.pkl"))
